...
class AduitPolicyReport
  ...
  def generate
    ...
    CSV.open(file_name, "w") do |csv|
      ...
      policies_by_subscriber_1095a.first(100).each do |row, policies|
        policies.each do |policy|
          begin
            ...
            policy_end_date = policy.policy_end.present? ? policy.policy_end.strftime("%m/%d/%Y") : '12/31/2021'
...
apr = AduitPolicyReport.new(2021)
apr.generate
