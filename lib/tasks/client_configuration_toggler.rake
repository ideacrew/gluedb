...
# This will switch the current rails configuration to a different state for another client by moving around YML configuration files
# held in the config/client_config/#{client_state_abbreviation}
# Pass the state abbreviation as an arguement.
