...
module Generators::Reports  
  class IrsYearlySerializer
    ...
    def load_responsible_party_data
      book = Spreadsheet.open "#{Rails.root}/2020_RP_Data.xls" # 2019_RP_Demographic.xls # 2018_RP_data.xls
    ...
    def policies_by_subscriber
      ...
      PolicyStatus::Active.between(Date.new(2019,12,31), Date.new(2020,12,31)).results.where({
