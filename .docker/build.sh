...
cp .docker/unicorn.rb config/
cp .docker/secrets.yml config/
...
cp app/models/exchange_information.rb.tmp app/models/exchange_information.rb
cp config/environments/production.rb.tmp config/environments/production.rb
cp config/initializers/devise.rb.tmp config/initializers/devise.rb
cp config/mongoid.yml.tmp config/mongoid.yml
cp config/unicorn.rb.tmp config/unicorn.rb
